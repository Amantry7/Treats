...
JAZZMIN_SETTINGS = {
    "site_title": "Treat",  # Заголовок админ-панели
    "site_header": "Treat",  # Заголовок на экране входа
    "site_brand": "Treat",  # Бренд в верхней части админ-панели
    "welcome_sign": "Добро пожаловать в Treat",  # Приветственное сообщение
    "site_title": "Treat",  # Заголовок админ-панели
    "site_header": "Treat",  # Заголовок на экране входа
    "site_brand": "Treat",  # Бренд в верхней части админ-панели
    "welcome_sign": "Добро пожаловать в Treat",  # Приветственное сообщение
